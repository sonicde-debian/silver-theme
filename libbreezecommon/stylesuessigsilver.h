...
class RenderStyleSuessigSilver18By18 : public RenderStyleSilver18By18
{
public:
    /**
     ...
     */
    RenderStyleSuessigSilver18By18(QPainter *painter,
                                   const bool fromKstyle,
                                   const bool boldButtonIcons,
                                   const qreal devicePixelRatio,
                                   const QPointF &deviceOffsetTitleBarTopLeftToIconTopLeft,
                                   const bool forceEvenSquares)
        : RenderStyleSilver18By18(painter, fromKstyle, boldButtonIcons, devicePixelRatio, deviceOffsetTitleBarTopLeftToIconTopLeft, forceEvenSquares) { };
