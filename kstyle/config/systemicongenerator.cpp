                                               ...
                                               const DecorationColors &decorationColors)
{
    ...
    iconThemeGroup.writeEntry("Comment", QString(themeName + i18n(" by Joseph Crowell, auto-generated by silver-settings")));
        ...
        for (auto size = m_iconSizes.begin(); size != m_iconSizes.end(); size++) {
            ...
            if (i == 0) {
                if (!iconThemeGroup.readEntry("Directories", "").isEmpty()) {
                    iconThemeGroup.writeEntry("Directories",
                                              QStringLiteral("%1,%2").arg(iconThemeGroup.readEntry("Directories") + QStringLiteral(",") + svgDirName));
                } else {
                    iconThemeGroup.writeEntry("Directories", svgDirName);
                }
            } else {
                if (!iconThemeGroup.readEntry("ScaledDirectories", "").isEmpty()) {
                    iconThemeGroup.writeEntry("ScaledDirectories",
                                              QStringLiteral("%1,%2").arg(iconThemeGroup.readEntry("ScaledDirectories") + QStringLiteral(",") + svgDirName));
                } else {
            ...
            for (auto &iconType : m_iconTypes) {
                ...
                svgGenerator.setDescription(i18n("Auto-generated by silver-settings"));
