...
void SystemIconGenerator::generate()
{
    ...
    generateIconThemeDir(lightIconsPath, QStringLiteral("Silver"), m_internalSettings->silverIconThemeInherits(), decorationColorsLight);
    ...
    generateIconThemeDir(darkIconsPath, QStringLiteral("Silver Dark"), m_internalSettings->silverDarkIconThemeInherits(), decorationColorsDark);
}
                                               ...
                                               const DecorationColors &decorationColors)
{
    ...
    KConfigGroup iconThemeGroup = themeIndex.group(QStringLiteral("Icon Theme"));
    iconThemeGroup.writeEntry("Name", themeName);
    iconThemeGroup.writeEntry("Comment", QString(themeName + i18n(" by Joseph Crowell, auto-generated by Silver window decoration")));
    ...
    for (int i = 0; i < m_scales.count(); i++) {
        for (auto size = m_iconSizes.begin(); size != m_iconSizes.end(); size++) {
            ...
            for (auto &iconType : m_iconTypes) {
                ...
                svgGenerator.setDescription(i18n("Auto-generated by Silver window decoration"));
